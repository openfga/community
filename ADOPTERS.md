...
| [Scalekit](https://www.scalekit.com/) | Scalekit uses OpenFGA for relationship-based authorization across its B2B auth platform: workspace, environment, and organization hierarchy, plus platform and dashboard RBAC. Structural tuples are stored in OpenFGA. Membership and role checks are evaluated per request. |
